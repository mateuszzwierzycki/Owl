...
Namespace Probability
    ...
    Public Class QAgent
        ...
        ''' </summary>
        ''' <returns></returns>
        Private Property RndCount As Integer = 0
        Private Property RndSeed As Integer = 123
        ...
        Public Sub New(QMatrix As List(Of List(Of Integer)), Seed As Integer)
            Me.QMatrix = QMatrix
        ...
        Public Sub New(QMatrix As List(Of List(Of Integer)), QValues As SortedList(Of Tuple(Of Integer, Integer), Double), Seed As Integer)
            Me.QMatrix = QMatrix
            Me.QValues = QValues
            Me.Rnd = New Random(Seed)
            Me.RndSeed = Seed
        ...
        Private Sub New(Other As QAgent)
            Me.QMatrix = DuplicateQMatrix(Other.QMatrix)
            Me.QValues = DuplicateQValues(Other.QValues)
        ...
        Private Function DuplicateRandom() As System.Random
            Dim nr As New Random(RndSeed)
            For i As Integer = 0 To RndCount - 1
                nr.Next()
            Next
            Return nr
        End Function
        ...
        Private Function NextRandomDouble() As Double
            Dim ret As Double = Rnd.NextDouble
            RndCount += 1
            Return ret
        End Function
